...
namespace UndoRedo
{
	...
	{
		private static UR_CommandMgr s_instance = null;
		public static UR_CommandMgr Instance { get{ return s_instance == null ? s_instance = new UR_CommandMgr() : s_instance; } }
		...
		public bool Redo()
		{
			if (IsRedoable)
			{
				UR_ICommand cmd = m_redoCommands[m_redoCommands.Count-1];
